...
const HeroBanner = () => {
  return (
    <div className="">
      <div className="relative overflow-x-hidden overflow-y-auto lg:overflow-hidden h-screen bg-[#f4f1e7]">
           ...
           <div className="pb-4">
            ...
            <div className="">
              <div className="mt-10">
                ...
                <div
                  aria-hidden="true"
                  className="pointer-events-none relative lg:inset-y-0 lg:mx-auto lg:w-full lg:max-w-7xl"
                >
                  <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
                    <div className="flex items-center space-x-6 lg:space-x-8">
                      <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                        <div className="h-64 w-44 overflow-hiden rounded-lg sm:opacity-0 lg:opacity-100">
                          <Image
                            width={300}
                            height={300}
                            src={fibre}
