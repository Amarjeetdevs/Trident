            ...
            <div className="p-4 w-sm py-6 rounded-lg bg-gray-50 md:p-8">
              <form onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#98431e]  rounded-lg hover:bg-white hover:text-black focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50"
                >
                  Send message
                </button>
              </form>
